          ...
          <table className="w-full text-left text-sm">
            <thead>
              <tr className="border-b border-gray-700">
                ...
                <th className="px-4 py-3 text-gray-400 font-medium">Descrição</th>
                ...
                <th className="px-4 py-3 text-gray-400 font-medium hidden md:table-cell">Forma Pgto</th>
              ...
              {despesasFiltradas.length === 0 ? (
                ...
                despesasFiltradas.map((despesa, i) => (
                  <tr key={despesa.id} className={`border-b border-gray-700/50 ${i % 2 === 0 ? 'bg-gray-800' : 'bg-gray-800/50'}`}>
                    ...
                    <td className="px-4 py-3 text-gray-400 hidden md:table-cell">{despesa.formaPagamento}</td>
                    <td className="px-4 py-3 text-[#FF4444] text-right font-semibold">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-center gap-1">
                        ...
                        <button
                          onClick={() => { setIdParaDeletar(despesa.id); setConfirmAberto(true) }}
            ...
            {despesasFiltradas.length > 0 && (
              <tfoot>
                <tr className="border-t-2 border-gray-600">
                  ...
                  <td className="px-4 py-3 text-[#FF4444] text-right font-bold">
                    {formatarMoeda(total)}
                  </td>
                  <td colSpan="2"></td>
                </tr>
